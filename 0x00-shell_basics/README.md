The first script prints the current working di
That was my first content in my readme.md these things are going to have a lot.of.typos God abeg!, ok so moving on tbus dir contains scripts and concepts relating to BASH, kinda of an intro to bash the basics
*imp some of the descriptions are sourced finspired by previous works, conceptts with an starr mean i havent fully understood such concepts yet* 
